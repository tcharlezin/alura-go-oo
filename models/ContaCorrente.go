...
func (c *ContaCorrente) CashOut(valor float32) string {
...
func (c *ContaCorrente) CashIn(valor float32) (string, float32) {
...
func (c *ContaCorrente) Transfer(valorTransferencia float32, contaDestino interfaces.IContaBancaria) string {
